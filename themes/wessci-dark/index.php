...
<main class="site-main" id="main">
	...
	<div class="issueline">
		<span class="issueline__label">Current issue</span>
		<span class="issueline__rule" aria-hidden="true"></span>
		<span class="issueline__meta">Vol. 1 · No. 1 · October 2026</span>
		<a class="issueline__link" href="<?php echo esc_url( home_url( '/archives/' ) ); ?>">All issues</a>
	</div>
	...
	<section class="submit">
		<h2 class="submit__title">Submitting to the journal</h2>
		...
		<a class="btn btn--ghost" href="<?php echo esc_url( home_url( '/submit/' ) ); ?>">Submission guidelines</a>
	</section>
