<?php
/**
 * WesSciJo — Editorial Brutalist
 * Concept theme for The Wesleyan Science Journal.
 */

function wessci_brutal_setup() {
...
add_action( 'after_setup_theme', 'wessci_brutal_setup' );
...
function wessci_brutal_assets() {
	...
	wp_enqueue_style( 'wessci-brutal', get_stylesheet_uri(), array( 'wessci-fonts' ), '1.0.0' );
}
add_action( 'wp_enqueue_scripts', 'wessci_brutal_assets' );
