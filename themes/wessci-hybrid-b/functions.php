...
function wessci_hybrid_b_setup() {
...
add_action( 'after_setup_theme', 'wessci_hybrid_b_setup' );

function wessci_hybrid_b_assets() {
	wp_enqueue_style(
		'wessci-fonts',
		'https://fonts.googleapis.com/css2?family=Libre+Franklin:wght@300;400;500;600;700&family=IBM+Plex+Mono:wght@400;500&display=swap',
		array(),
		null
	);
	wp_enqueue_style(
...
add_action( 'wp_enqueue_scripts', 'wessci_hybrid_b_assets' );
